    ...
    <div className="max-w-4xl mx-auto">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-primary-500 to-primary-600 px-6 py-8">
          <div className="flex items-center space-x-4">
            <img
              src={user?.photoURL || `https://ui-avatars.com/api/?name=${user?.name}&background=ffffff&color=3b82f6&size=80`}
              alt={user?.name}
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 text-center">
          ...
          <div className="text-gray-600 dark:text-gray-300">Completed Trips</div>
        </div>
        
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 text-center">
          <div className="text-3xl font-bold text-blue-600 mb-2">৳15,400</div>
